...
const LF: u8 = 0x0a; // 10 line feed
const CR: u8 = 0x0d; // 13 carriage return
const DL: u8 = 0x7f; // 127 delete
const BS: u8 = 0x08; // 8 backspace
        ...
        match c {
            LF | CR => {
                ...
                if !line.is_empty() {
                    ...
                    args_copy.iter_mut().for_each(|string| string.push('\0'));
